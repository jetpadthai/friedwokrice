...
class Siteground_SuperCacher_Helper_Debug extends Mage_Core_Helper_Abstract {
    /**
    ...
    public function logBackTrace( $backTrace=null ) {
        ...
        $btuuid = Mage::helper( 'supercacher/data' )->generateUuid();
