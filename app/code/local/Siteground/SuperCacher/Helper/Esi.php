...
class Siteground_SuperCacher_Helper_Esi extends Mage_Core_Helper_Abstract {
    ...
    const MAGE_CACHE_NAME           = 'supercacher_esi_blocks';
    ...
    public function shouldResponseUseEsi() {
        return Mage::helper( 'supercacher/varnish' )->shouldResponseUseVarnish() &&
            $this->getEsiEnabled();
    }
    ...
    public function shouldFixFlashMessages() {
        return Mage::helper( 'supercacher/data' )->useFlashMessagesFix() &&
     ...
     * supercacher/esi/getBlock while rendering ESI blocks. Not perfect, but may
     * be good enough
     *
    ...
    public function getDummyRequest( $url=null ) {
        ...
        $request = new Siteground_SuperCacher_Model_Dummy_Request( $url );
    ...
    public function getCacheClearEvents() {
        Varien_Profiler::start( 'supercacher::helper::esi::getCacheClearEvents' );
        ...
        Varien_Profiler::stop( 'supercacher::helper::esi::getCacheClearEvents' );
    ...
    public function getLayoutXml() {
        Varien_Profiler::start( 'supercacher::helper::esi::getLayoutXml' );
        ...
        Varien_Profiler::stop( 'supercacher::helper::esi::getLayoutXml' );
    ...
    public function getCacheClearEventsCacheKey() {
        ...
        return Mage::helper( 'supercacher/data' )
    ...
    protected function _loadEsiCacheClearEvents() {
        Varien_Profiler::start( 'supercacher::helper::esi::_loadEsiCacheClearEvents' );
        ...
        Varien_Profiler::stop( 'supercacher::helper::esi::_loadEsiCacheClearEvents' );
        return $events;
    }
    ...
    protected function _loadLayoutXml() {
        Varien_Profiler::start( 'supercacher::helper::esi::_loadLayoutXml' );
        $design = Mage::getDesign();
        $layoutXml = Mage::getSingleton( 'core/layout' )
            ...
            ->getFileLayoutUpdatesXml(
                ...
                $design->getTheme( 'layout' ),
                Mage::app()->getStore()->getId() );
        Varien_Profiler::stop( 'supercacher::helper::esi::_loadLayoutXml' );
        return $layoutXml;
    }
}
