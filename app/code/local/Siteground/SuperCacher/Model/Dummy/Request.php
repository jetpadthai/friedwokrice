...
class Siteground_SuperCacher_Model_Dummy_Request extends
    ...
    public function fakeRouterDispatch() {
        if( $this->_cmsRouterMatch() ) {
            Mage::helper( 'supercacher/debug' )->logDebug( 'Matched router: cms' );
        } elseif( $this->_standardRouterMatch() ) {
            Mage::helper( 'supercacher/debug' )->logDebug( 'Matched router: standard' );
        } elseif( $this->_defaultRouterMatch() ) {
            Mage::helper( 'supercacher/debug' )->logDebug( 'Matched router: default' );
        } else {
            Mage::helper( 'supercacher/debug' )->logDebug( 'No router match' );
        }
    }
