 ...
 */
class Siteground_SuperCacher_Model_Shim_Mage_Core_App extends Mage_Core_Model_App {
     ...
     * @return Siteground_SuperCacher_Model_Shim_Mage_Core_App
     */
     ...
     * Get the config shim
     *
     * @return Siteground_SuperCacher_Model_Shim_Mage_Core_Config
     */
    protected function _shim_getConfigShim() {
        return Mage::getModel( 'supercacher/shim_mage_core_config' );
    }
}
